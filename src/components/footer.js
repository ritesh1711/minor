        ...
        <div>
            ...
            <div className='flex flex-row bg-blue-600 h-50 text-white py-4 bottom-0 w-full '>
                ...
                <div>
                    ...
                    <div className='text-2xl hover:text-red-400'> Facebook</div>
                    <div className='text-2xl hover:text-red-400'> Twitter</div>
                    <div className='text-2xl hover:text-red-400'> Instagram</div>
                </div>
            </div>
